...
class AlertDialogButton extends StatelessWidget {
  AlertDialogButton({Key? key, required this.buttonText, required this.titleText, required this.submitButton, required this.mainContent, required this.action}) : super(key: key);
